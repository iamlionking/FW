...
//
//*****************************************************************************
#define DEFAULT_PIN_CODE "1234567"
...
#define BLUETOOTH_STACK_ID		(unsigned int)1
...
extern bool g_toggleBTDiscoverability;
extern char * g_pcHCIVersionStrings[8];
extern unsigned int g_uiBluetoothStackID;
...
extern int PinCodeResponse(unsigned char *pucBDAddr, int iPinCodeLength,
                           char *pucPinCode);
extern bool GetInitializationStatus();
