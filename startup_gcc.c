...
extern void USBActivityIntHandler(void);
#endif
...
extern void _bus_fault_handler_asm(void);
...
//    (void (*)(void))((unsigned long)pulStack + sizeof(pulStack)),
    ...
    _bus_fault_handler_asm,       			// The bus fault handler
    __usage_fault,                          // The usage fault handler
    0,                                      // Reserved
    0,                                      // Reserved
    0,                                      // Reserved
    0,                                      // Reserved
...
//    IntDefaultHandler,                      // GPIO Port Q6
    USBActivityIntHandler,                  // GPIO Port Q6
